...
import { FaAlignLeft, FaBuffer, FaGear, FaHouseChimneyUser, FaRegPenToSquare, FaUser } from "react-icons/fa6";
        ...
        <aside className={` ${sidebar ? "left-0" : "left-[-250px]"}  w-[250px] transition-all duration-300 bg-bg_secondary h-full fixed z-[999]  top-0`}>
          ...
          <nav className="pt-[20px]">
            <ul className="grid gap-[8px]">
              ...
              <li>
                <NavLink to="/create-invoice" className={(navData) =>
                  navData.isActive ? "navActive" : "navNotActive"
                }>
                  <span className="flex items-center gap-2">
                    <FaRegPenToSquare />
              ...
              <li >
                <NavLink to="/all-invoice" className={(navData) =>
                  ...
                  <span className="flex items-center gap-2">
                    <FaBuffer />
                    <span className="leading-none">All Invoice</span>
                  </span>
