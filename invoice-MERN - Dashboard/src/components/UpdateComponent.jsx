...
let UpdateComponent = () => {
  ...
  return (
    <>
      <section className="px-[15px] py-[30px] md:px-[40px] md:py-[40px]">
        <div>
          <div className="grid grid-cols-12 gap-[20px]">

            {
              loading === true ? (
                <div className="p-[20px] bg-white rounded-md col-span-12 xl:col-span-9">
                  <SkeletonTheme
                    baseColor="#ebebeb"
            ...
            {
              loading === true ? (
                <div className="p-[20px] bg-white rounded-md col-span-12 xl:col-span-3">
                  <SkeletonTheme
                    baseColor="#ebebeb"
                    highlightColor="#f5f5f5"
                    className="w-100vw"
                ...
                <div className="bg-white rounded-md shadow-lg py-[40px] px-[20px]">
                  ...
                  <div>
                    <div className="w-full mt-[30px]">
                      <button
                        onClick={() => saveInvoice()}
                        className="px-[20px] w-full py-[8px] rounded-md bg-primary/90 hover:bg-primary text-white transition-all duration-300"
                      >
                        Update Invoice
                      </button>
                    </div>
